	...
	$.fn.embedVideo = function (options) {
		$(this).each(function () {
			...
			if (settings.video_src == "kaltura") {
				...
				var videoid = settings.video_url.match(
				...
				settings.video_id = settings.video_url
			...
			var videoContainer = $("<div>").attr({
				style:
					"width: 100%; margin: 0 auto; max-width: " + settings.maxWidth + ";",
